...
The idea was that is a user typed in a sadder, more gloomy text then the horizon and sky would be darker colours, and if the user typed happy text it would display more bright colours.
